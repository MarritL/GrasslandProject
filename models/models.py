...
class ModelsClass:
    ...
    def AtrousFCN_Resnet53_16s(self, weight_decay=0., batch_momentum=0.9):
        ...
        x = Conv2D(self.n_classes, (1, 1), kernel_initializer='he_normal', activation='softmax', padding='same', strides=(1, 1), kernel_regularizer=l2(weight_decay))(x)
